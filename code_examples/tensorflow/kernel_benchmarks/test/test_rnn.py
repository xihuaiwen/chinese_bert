...
class TestTensorFlowRNNBenchmarks(SubProcessChecker):
    ...
    def test_inference_b256_s25_h1024(self):
        self.run_command("python3 rnn.py --batch-size 256 --timesteps 25 --hidden-size 1024 --use-data",
                         working_path,
                         [r"(\w+.\w+) items/sec"])
    ...
    def test_train_b64_s25_h512(self):
        self.run_command("python3 rnn.py --batch-size 64 --timesteps 25 --hidden-size 512 --train --use-data",
                         working_path,
                         [r"(\w+.\w+) items/sec"])
